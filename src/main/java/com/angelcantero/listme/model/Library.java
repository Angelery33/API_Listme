 ...
 * </p>
 * <p>
 * Entidad que representa una biblioteca o colección de ítems del usuario.
 * </p>
 * <p>
 * Una biblioteca es un contenedor lógico que agrupa ítems relacionados
 * (ej: "Mis libros de fantasía", "Anime veraniego", "Videojuegos RPG").
 * </p>
 *
...
public class Library {
        ...
        @JoinTable(name = "library_editors", joinColumns = @JoinColumn(name = "library_id", referencedColumnName = "id_library"), inverseJoinColumns = @JoinColumn(name = "user_id", referencedColumnName = "id"))
         ...
         */
        @ManyToMany(fetch = FetchType.LAZY)
        @JoinTable(name = "library_viewers", joinColumns = @JoinColumn(name = "library_id", referencedColumnName = "id_library"), inverseJoinColumns = @JoinColumn(name = "user_id", referencedColumnName = "id"))
